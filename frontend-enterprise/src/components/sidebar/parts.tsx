...
export function SidebarFooterActions({ onOpenChat }: { onOpenChat: () => void }) {
  return (
    <div
      className={cn(
...
export function CollapsedGroupLabel({ children }: { children: string }) {
  return (
...
export function CollapsedAgentSwitcher({
  sidebarAgent,
  scopeAgents,
  selectedAgentId,
  onSelectAgent,
